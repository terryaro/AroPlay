...
function BASS_Encode_UserOutput(handle:DWORD; offset:QWORD; buffer:Pointer; length:DWORD): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF}; external bassencdll;
...
function BASS_Encode_GetCARef(handle:DWORD): Pointer; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF}; external bassencdll;
{$ENDIF}
